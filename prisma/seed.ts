...
const main = async () => {
  ...
  try {
    ...
    const categoryMap = Object.fromEntries(
      createdCategories.map((c) => [c.categoryName, c.id]),
    );
    ...
    const sampleWallpapers = [
      ...
      },
      {
        ...
        imageUrl:
          "https://images.unsplash.com/photo-1518895949257-7621c3c786d7?w=1920",
        width: 1920,
        height: 1080,
        format: "jpg",
      ...
      },
      {
        ...
        imageUrl:
          "https://images.unsplash.com/photo-1558591710-4b5a4aead266?w=1920",
        width: 1920,
        height: 1080,
        format: "jpg",
    ...
    await prisma.like.deleteMany({
      where: {
        wallpaper: { imageUrl: { in: seededImageUrls }, userId: adminUser.id },
      },
    });
